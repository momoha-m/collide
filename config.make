...
HDF5_ROOT = /Users/momoha/miniforge3/envs/of-hdf5
PROJECT_LDFLAGS += -L$(HDF5_ROOT)/lib -Wl,-rpath,$(HDF5_ROOT)/lib -lhdf5_cpp -lhdf5
...
#   Note: Leave a leading space when adding list items with the += operator
################################################################################
PROJECT_CFLAGS += -I$(HDF5_ROOT)/include
